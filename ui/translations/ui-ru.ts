...
Dialog action. Should be equal to the corresponding Sailfish translation</extracomment>
    ...
    <message id="id_directory_empty">
        ...
        <translation>Директория пуста</translation>
    </message>
    ...
    <message id="id_renaming_not_allowed">
        ...
        <translation>Переименование недоступно</translation>
    </message>
    ...
    <message id="id_copy_from_whitelist">
        ...
        <extracomment>Action in phone numbers list</extracomment>
        <translation>Скопировать из белого списка</translation>
    </message>
    <message id="id_copy_from_blacklist">
        <source>Copy from black list</source>
        <extracomment>Action in phone numbers list</extracomment>
        <translation>Скопировать из чёрного списка</translation>
    </message>
...
Page header</extracomment>
    ...
    <message id="id_flac_encoder">
        ...
        <translation>Кодировщик FLAC</translation>
    </message>
    ...
    <message id="id_backup_description">
        ...
        <translation>Создайте резервную копию, чтобы сохранить записанные звонки и настройки. Используйте её позднее, чтобы восстановить исходное состояние на другом устройстве или после сброса устройства.</translation>
    </message>
    <message id="id_estimating_backup_size">
        <source>Estimating backup size...</source>
        <translation>Оценка размера резервной копии...</translation>
    </message>
    <message id="id_estimated_backup_size">
        ...
        <translation>Примерный размер резервной копии: %1</translation>
    </message>
    ...
    <message id="id_restore_description">
        ...
        <translation>Выберите резервную копию, созданную Записью звонков ранее, чтобы восстановить её на этом устройстве.</translation>
    </message>
    ...
    <message id="id_backup_invalid">
        ...
        <extracomment>Information label</extracomment>
        <translation>Выбранный файл не содержит резервную копию Записи звонков</translation>
    </message>
    ...
    <message id="id_backup_location_hint">
        ...
        <translation>Резервная копия будет записана в следующий файл:</translation>
    </message>
    ...
    <message id="id_unpacked_size">
        ...
        <extracomment>Backup file details</extracomment>
        <translation>Распакованный размер</translation>
    </message>
    <message id="id_files">
        <source>Files</source>
        <extracomment>Backup file details</extracomment>
    ...
    <message id="id_dont_remove_existing_recordings">
        ...
        <translation>Не удалять существующие записи</translation>
    </message>
    <message id="id_dont_remove_existing_recordigns_description">
        ...
        <extracomment>Restore description</extracomment>
        <translation>Оставить все существующие аудио файлы нетронутыми, из можно добавить в список позднее с помощью утилиты восстановления базы данных</translation>
    </message>
    ...
    <message id="id_removing_old_data">
        ...
        <extracomment>Backup operation description</extracomment>
        <translation>Удаление старых данных...</translation>
    </message>
...
Database repair progress</extracomment>
    ...
    <message id="id_unable_to_write_archive">
        ...
        <translation>Не удалось записать архив</translation>
    </message>
...
Database repair error description</extracomment>
        <translation>Не удалось начать операцию</translation>
    </message>
    ...
    <message id="id_backup_file_not_exists">
        ...
        <extracomment>Backup error description</extracomment>
        <translation>Файл резервной копии не существует</translation>
    </message>
...
Database repair error description</extracomment>
    ...
    <message id="id_performing_backup_description">
        ...
        <translation>Идёт создание резервной копии. Не закрывайте приложение, пока операция не будет завершена.</translation>
    </message>
    <message id="id_performing_restore_description">
        ...
        <translation>Идёт восстановление резервной копии. Не закрывайте приложение, пока операция не будет завершена. Это может привести к повреждению данных и непредсказуемым результатам.</translation>
    </message>
    ...
    <message id="id_restore_success_description">
        ...
        <translation>База данных, настройки и записи успешно восстановлены. Программа должна быть перезапущена, чтобы применить изменения. Если необходимо добавить в список старые записи, запустите утилиту восстановления базы данных из соответствуюего меню настроек после перезапуска.</translation>
    </message>
    ...
    <message id="id_daemon_active_description">
        ...
        <translation>Записываются все входящие и исходящие звонки</translation>
    </message>
    ...
    <message id="id_automatic_startup_description">
        ...
        <translation>Автоматический запуск при перезагрузке</translation>
    </message>
    ...
    <message id="id_black_list_description">
        ...
        <translation>Записываются все номера, кроме указанных в чёрном списке</translation>
    </message>
    <message id="id_white_list_description">
        ...
        <translation>Записываются только номера из белого списка</translation>
    </message>
...
Section header</extracomment>
    ...
    <message id="id_performing_repair_description">
        ...
        <translation>Идёт восстановление базы данных. Не закрывайте приложение, пока операция не будет завершена.</translation>
    </message>
    ...
    <message id="id_processing_orphaned_files">
        ...
        <extracomment>Database repair progress</extracomment>
        <translation>Обработка бесхозных файлов...</translation>
    </message>
    <message id="id_processing_orphaned_records">
        <source>Processing orphaned records...</source>
        <extracomment>Database repair progress</extracomment>
        <translation>Обработка бесхозных записей...</translation>
    </message>
    ...
    <message id="id_location_description">
        ...
        <translation>Расположение записанных файлов</translation>
    </message>
    ...
    <message id="id_orphaned_records">
        ...
        <translation>Бесхозные записи</translation>
    </message>
    <message id="id_orphaned_records_skip">
        ...
        <translation>Запись будет оставлена в базе данных, если к ней нет соответствующего файла</translation>
    </message>
    <message id="id_orphaned_records_remove">
        ...
        <translation>Запись будет удалена из базы данных, если к ней нет соответствующего файла</translation>
    </message>
...
&quot;remove&quot; option for comboboxes (lowercased)</extracomment>
    ...
    <message id="id_orphaned_files">
        ...
        <extracomment>Combobox label</extracomment>
        <translation>Бесхозные файлы</translation>
    </message>
    <message id="id_orphaned_files_skip">
        ...
        <translation>Файл будет оставлен, если на него не ссылаются записи в базе данных</translation>
    </message>
    <message id="id_orphaned_files_remove">
        ...
        <translation>Файл будет удалёт, если на него не ссылаются записи в базе данных</translation>
    </message>
